DApp = {
    ...
    development: false,
    //Rinkeby:
    factoryAddress: "0x418155C5021e2372F59D71B607cE9F93d5520282",
    tokenAddress: "0xaDD8A06fd58761A5047426e160B2B88AD3B9D464",
    ...
    initWeb3: function() {
        ...
        if (typeof web3 !== 'undefined') {
          ...
          DApp.web3Provider = new Web3.providers.HttpProvider('https://bsc-dataseed1.defibit.io');
        }
    ...
    getCheeseFarmContract: function(){
        if(DApp.development)
            return DApp.cheeseFarmContract.deployed();
        else
            return DApp.cheeseFarmContract.at(DApp.tokenAddress);
    },
    ...
    initContract: function(){
        $.getJSON('../contracts/TimeLockedWalletFactory.json', function(factoryContract){
            ...
            //hardcoding CheeseFarm for simplicity
            $.getJSON('../contracts/CheeseFarm.json', function(cheeseFarmContract){
                DApp.cheeseFarmContract = TruffleContract(cheeseFarmContract);
                DApp.cheeseFarmContract.setProvider(DApp.web3Provider);
                console.log("[x] CheeseFarm contract initialized.");
    ...
    updateClaimForm: function(){
        ...
        if(currency == "ether"){
            ...
            var cheeseFarmValue = DApp.getKnownWalletBallance(wallet, 'cheeseFarm')
    ...
    hashFormatter: function(hash, row, index){
        ...
        return `<a href="https://www.bscscan.com/address/${hash}">${shortHash}...</a>`;
    },
    ...
    valueFormatter: function(cell, row){
        ...
        var html = '';
        if(ethValue > 0) { html += `${ethValue} BNB</br>`}
        if(toptalValue > 0) { html += `${toptalValue} CheeseFarm`}
